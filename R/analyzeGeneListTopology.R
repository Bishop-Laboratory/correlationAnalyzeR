...
# source("Code/myGSEA.R")
# # # Make TERM2GENE
# # simpleMdf <- msigdbr::msigdbr(category = c("H", "C1", "C2", "C5", "C6"))
# # TERM2GENE <- simpleMdf[,c(1,5)]
# # save(TERM2GENE, file = "Data/GSEA_Data/hsapiens/TERM2GENE.SIMPLE.RData")
#
# # Function main code
